...
def set_scaled_dot_product_attention_impl(scaled_dot_product_attention_impl : Callable) -> None:
    """
...
def fuse_scaled_dot_product_attention(gm: torch.fx.GraphModule):
    ...
    pmap = { pattern : replacement for pattern, replacement in _scale_factor_dot_product_attention_replacement_graph_modules }
